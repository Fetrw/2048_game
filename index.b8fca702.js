...
function updateUI() {
    ...
    messageContainer.querySelectorAll(".message").forEach((message)=>message.classList.add("hidden"));
    if (currentStatus === "win") messageElements.win.classList.remove("hidden");
    else if (currentStatus === "lose") messageElements.lose.classList.remove("hidden");
    else if (currentStatus === "playing") messageElements.start.classList.add("hidden");
    else messageElements.start.classList.remove("hidden");
}
